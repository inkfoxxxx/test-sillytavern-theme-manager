    ...
    const initInterval = setInterval(() => {
        ...
        if (originalSelect && updateButton && saveAsButton && window.SillyTavern?.getContext && !document.querySelector('#theme-manager-panel')) {
            ...
            try {
                ...
                const COLLAPSED_FOLDERS_KEY = 'themeManager_collapsedFolders'; // 【新功能】用于存储折叠状态的键
                ...
                const expandAllBtn = managerPanel.querySelector('#expand-all-btn'); // 【新功能】获取按钮
                const collapseAllBtn = managerPanel.querySelector('#collapse-all-btn'); // 【新功能】获取按钮
